...
To connect the two devices, the pins shall be checked to locate the corresponding SCL and SDA pins on each board. This protocol is then configured on each board. In the case of **Arduino**, no configuration will be necessary. In the case of the Raspberry Pi, this had to be enabled. 
